...
addp = []
# 外資買賣力道
addp.append(mpf.make_addplot(data['D_day'],
            panel=1, type='bar', secondary_y=False))
addp.append(mpf.make_addplot(data['D_month'],
            panel=1, color='red', secondary_y=False))
addp.append(mpf.make_addplot(data['D_mean'],
            panel=1, color='blue', secondary_y=False))
